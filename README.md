...
Im Standardkatalog sind `ABC der Tiere 1`, `ABC der Tiere 2`, `MiniMax 1` und `MiniMax 2` hinterlegt. `ABC der Tiere 1` enthält den Schreiblehrgang Teil A und Teil B. `MiniMax 1` und `MiniMax 2` werden kompakt als Themen mit Seitenbereichen geführt und nicht sichtbar in Basis/Training/Extra/Test zerlegt.
