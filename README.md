...
Im Standardkatalog sind aktuell die vorhandenen Klasse-2-Materialien `ABC der Tiere 2` und `MiniMax 2` hinterlegt. `ABC der Tiere 1` und `MiniMax 1` werden nicht angezeigt, solange sie nicht später über `+ Material hinzufügen` ergänzt werden. MiniMax 2 wird kompakt als Thema mit Seitenbereich geführt und nicht sichtbar in Basis/Training/Extra/Test zerlegt.
